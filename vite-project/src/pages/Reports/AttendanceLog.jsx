...
//                     <div
//                         key={log.id}
//                         className="p-4 border border-slate-100 rounded-2xl hover:bg-slate-50 transition-all"
//                     >
...
//                                 <p className={`text-xs font-bold ${log.status === "On Time"
//                                         ? "text-emerald-500"
//                                         : "text-amber-500"
//                                     }`}>
//                                     ● {log.status}
...
//                             {/* Middle Section */}
//                             <div className="space-y-2 md:flex md:gap-8 md:space-y-0">
//                                 <div>
...
//                             {/* Right Section */}
//                             <div>
//                                 <button className="w-full md:w-auto text-xs font-black uppercase tracking-widest py-2 px-5 bg-slate-100 text-slate-600 rounded-xl hover:bg-indigo-600 hover:text-white transition-all">
//                                     Details
//                                 </button>
//                             </div>
...
//                 <button className="text-xs font-black uppercase tracking-[0.2em] text-indigo-600 hover:text-indigo-800 transition-colors py-2 px-4 rounded-full border border-indigo-100 hover:bg-indigo-50">
//                     View Full History →
//                 </button>
//             </div>
//         </div>
