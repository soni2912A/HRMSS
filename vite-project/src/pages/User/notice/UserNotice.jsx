...
//   useEffect(() => {
//     // demo data (backend/localStorage replace करू शकतोस)
//     const stored = JSON.parse(localStorage.getItem("notices")) || [
//       {
//         title: "Republic Day Holiday",
//         description: "Office will remain closed on 26 January.",
//         priority: "High",
//         date: "2026-01-26",
//       },
//       {
//         title: "Team Meeting",
//         description: "Monthly meeting on Friday at 4 PM.",
//         priority: "Medium",
//         date: "2026-01-24",
//       },
//     ];
...
//                   <h2 className="text-lg font-bold text-[#0f2e2e]">
//                     {notice.title}
//                   </h2>

//                   <span
//                     className={`px-3 py-1 rounded-full text-[10px] font-bold ${priorityStyle[notice.priority]}`}
//                   >
//                     {notice.priority}
//                   </span>
//                 </div>
